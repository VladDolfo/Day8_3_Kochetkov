MakeBusinessTicket()
{
	srand(time(NULL));
  	...
  	lr_output_message("Выбор случайного билета Business класс = %d",randomT1);
  	lr_output_message("Значение outboundFlight выбранного билета = %s",businessticket[randomT1]);
